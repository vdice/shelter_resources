...
describe('the locator functionality', {:type => :feature}) do
  ...
  describe('the post path') do
    before(:each) do
      ...
      @shelters = [{:shelter => Shelter.create({:name => 'Transition Projects', :address => '665 Northwest Hoyt Street, Portland, OR 97209'}),
                    :expected_distance => '0.39'},
                   {:shelter => Shelter.create({:name => 'Portland Rescue Mission', :address => '111 West Burnside Street, Portland, OR 97209'}),
